...
export const featureApi = {
  ...
  getAvailableServices: async () => {
    try {
      ...
      console.warn(
        "Backend unavailable, using default available services list:",
        err,
      );
      ...
      return [
        {
          ...
          description:
            "Search physical books, digital assets, and holdings across libraries.",
          category: "Core",
          icon: "Search",
          isCore: true,
        },
        {
          ...
          description:
            "Manage checkouts, renewals, hold queues, and borrowing rules.",
          category: "Core",
          icon: "Library",
          isCore: true,
        },
        {
          ...
          description:
            "NFC/QR-based mobile library pass for student authentication.",
          category: "Core",
          icon: "CreditCard",
          isCore: true,
        },
        {
          ...
          name: "Fines & Payments",
          description:
            "Automated overdue fine calculation, payment gateway, and waivers.",
          category: "Core",
          icon: "Receipt",
        },
        {
          ...
          description:
            "In-app EPUB/PDF digital reader with DRM access controls.",
          category: "Engagement",
          icon: "FileText",
        },
        {
          ...
          description:
            "Faculty-curated reading materials linked directly to syllabus.",
          category: "Engagement",
          icon: "ListPlus",
        },
        {
          ...
          description:
            "Personalized book recommendations based on study major and history.",
          category: "Engagement",
          icon: "Sparkles",
        },
        {
          ...
          description:
            "Reading streaks, badges, leaderboards, and reading achievements.",
          category: "Engagement",
          icon: "Award",
        ...
        },
        {
          ...
          description:
            "Reserve study pods, lab workstations, and discussion rooms.",
          category: "Facilities",
          icon: "Monitor",
        ...
        },
        {
          ...
          description:
            "Student ticket system for librarian assistance and desk queries.",
          category: "Facilities",
          icon: "MessageSquare",
        },
        {
          ...
          description:
            "College-wide circulation metrics, peak hours, and stock auditing.",
          category: "Analytics",
          icon: "LineChart",
        },
      ];
  ...
  bulkUploadStudents: async (collegeId = "current", formData) => {
    try {
      const { data } = await apiClient.post(
        `/college/${collegeId}/students/bulk-upload`,
        formData,
        {
          headers: {
  ...
  getUploadJobStatus: async (jobId, collegeId = "current") => {
    try {
      const { data } = await apiClient.get(
        `/college/${collegeId}/students/upload/${jobId}`,
      );
      return data.data || data;
    } catch (err) {
        ...
        errors: [
          {
            row: 14,
            studentId: "STU-1014",
            error: "Email already exists in college database",
          },
