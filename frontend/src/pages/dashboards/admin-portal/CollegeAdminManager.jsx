...
import { Building2, Plus, CheckCircle2, Copy, Eye, EyeOff } from "lucide-react";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              ...
              <div className="bg-slate-950 border border-slate-800 p-3 rounded-lg space-y-1.5">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <code className="bg-slate-900 px-2 py-0.5 rounded text-emerald-400 font-bold border border-slate-800 tracking-wider">
                    {showTempPassword
                  ...
                  <button
                    ...
                    className="p-1 bg-slate-900 hover:bg-slate-800 text-slate-400 hover:text-white rounded border border-slate-700 transition-colors"
