...
const GeneralSaved = () => {
  ...
  return (
    <div className="flex flex-col min-h-full w-full max-w-[1600px] 2xl:max-w-[1760px] mx-auto p-3 sm:p-4 gap-4 font-sans pb-6 text-slate-900 dark:text-ink">
      <StickyControlBar
            ...
            <div className="flex items-center gap-2">
              ...
              {bookmarks.length > 0 && (
                <button
                  ...
                  className="px-2.5 py-1 bg-rose-50 dark:bg-rose-950/80 text-rose-600 dark:text-rose-300 hover:bg-rose-100 dark:hover:bg-rose-900 border border-rose-200 dark:border-rose-800/80 font-bold text-xs rounded-xl transition-all flex items-center gap-1 cursor-pointer"
      ...
      <BookDataState
        ...
        emptyState={
          <div className="bg-white dark:bg-surface p-8 sm:p-12 rounded-3xl border border-slate-200 dark:border-edge shadow-2xl text-center space-y-4 max-w-md mx-auto my-auto text-slate-900 dark:text-ink">
            <div className="p-4 bg-indigo-50 dark:bg-indigo-950 text-indigo-600 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-800/60 rounded-3xl w-14 h-14 mx-auto flex items-center justify-center">
              <Sparkles className="w-7 h-7" />
            </div>

            <div>
              <h3 className="text-base font-bold text-slate-900 dark:text-ink mb-1">
            ...
            <div className="flex flex-col sm:flex-row gap-2 justify-center pt-2">
              <button
                ...
                className="px-4 py-2 bg-indigo-600 text-white font-bold text-xs rounded-xl hover:bg-indigo-500 transition-all flex items-center justify-center gap-1.5 shadow-md shadow-indigo-600/20 cursor-pointer"
              >
          ...
          renderItem={(item) => {
            ...
            return (
              <div
                ...
                className="bg-white dark:bg-surface p-4 rounded-2xl border border-slate-200 dark:border-edge shadow-xl hover:border-indigo-500/50 hover:shadow-2xl transition-all duration-200 flex flex-col justify-between group relative text-slate-900 dark:text-ink"
              >
                <div>
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg text-slate-400 hover:text-rose-600 dark:hover:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/60 border border-transparent hover:border-rose-200 dark:hover:border-rose-800/60 transition-colors cursor-pointer"
                    >
                      <Trash2 className="w-3.5 h-3.5" />
                    </button>
                  </div>
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <div>
                      <h3 className="font-bold text-slate-900 dark:text-ink text-sm leading-snug line-clamp-2 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
                        {item.title}
                      </h3>
                      {item.author && (
                ...
                <div className="pt-3 border-t border-slate-100 dark:border-edge flex items-center justify-between gap-2 mt-auto">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-indigo-600 text-white hover:bg-indigo-500 font-bold text-xs rounded-xl transition-all flex items-center gap-1 flex-shrink-0 shadow-md shadow-indigo-600/20 cursor-pointer"
                  >
                    <span>
