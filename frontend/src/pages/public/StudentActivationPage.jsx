          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-slate-950 border border-slate-800 focus:border-indigo-500 rounded-xl px-4 py-3 pr-10 text-slate-100 text-sm focus:outline-none transition"
              />
              <button
                type="button"
