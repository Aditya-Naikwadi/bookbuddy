export const HELP_ARTICLES = [
  {
    ...
    summary:
      "Learn how to borrow physical books, view active due dates, and request loan extensions.",
    content: `
...
- Go to **My Loans** on your dashboard and click **Renew Loan**.
  ...
  },
  {
    ...
    summary:
      "Discover and request physical books and e-resources from partner institutions.",
    content: `
...
- View real-time status transitions (Requested → Approved → In Transit → Fulfilled) on your **Inter-Library Requests** timeline.
  ...
  },
  {
    ...
    summary:
      "Understand fine accrual and how to settle outstanding balances via Razorpay.",
    content: `
...
- Once verified by server webhook, your balance is automatically cleared and receipt generated.
  ...
  },
  {
    ...
    summary:
      "Download e-books and lab notes for offline reading without an active internet connection.",
    content: `
...
3. Access downloaded materials anytime via the **Offline Downloads** page, even when completely disconnected from the internet.
  ...
  },
  {
    ...
    summary:
      "Build daily reading habits, earn milestone stickers, and protect your streak with streak freezes.",
    content: `
