...
export const StreakDashboardCard = () => {
  ...
  const nextMilestone = rewards.find(
    (r) => r.streakDays > streak.currentStreak,
  );
      ...
      <CardContent className="relative z-10">
          ...
          <div className="space-y-2 mt-2">
            <div className="flex justify-between text-sm font-medium">
              ...
              <span className="text-muted-foreground">
                {nextMilestone.streakDays - streak.currentStreak} left
              </span>
            </div>
            <Progress
        ...
        {!streak.todayComplete && (
          <Button
            ...
            onClick={() => (window.location.href = "/eresources")}
          >
            Read Now
          </Button>
        )}
