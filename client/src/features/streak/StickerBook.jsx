    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Collect stickers by building your streak and exploring the library. You have {earnedCodes.size} of {catalog.length}.
        </p>
      </div>
                ...
                return (
                  ...
                  >
                    <CardContent className="p-6 flex flex-col items-center text-center gap-3">
                      <div className={`text-5xl drop-shadow-md transition-all ${isEarned ? 'scale-110' : 'grayscale opacity-20'}`}>
                        {sticker.icon}
                      </div>
                      ...
                      <div className="space-y-1 relative z-10 mt-2">
                        <h4 className="font-bold text-sm leading-tight">{sticker.name}</h4>
                        <p className="text-xs text-muted-foreground">{sticker.description}</p>
                      </div>
