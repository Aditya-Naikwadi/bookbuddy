...
const Register = () => {
  ...
  const strengthColor = 
    ...
    strength < 5 ? "bg-amber-500" : "bg-success";
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="w-full">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <motion.div variants={itemVariants} className="w-full sm:w-1/2">
            <label className="block text-xs font-medium text-muted mb-1.5 ml-1">ID Number</label>
            <input
              type="text"
              required
              disabled={isLoading}
          ...
          <motion.div variants={itemVariants} className="w-full sm:w-1/2">
            <label className="block text-xs font-medium text-muted mb-1.5 ml-1">Role</label>
            <select
              value={role}
              disabled={isLoading}
      ...
      >
        Already have an account? <Link to="/auth/login" className="text-indigo-400 font-medium hover:text-indigo-300 transition-colors">Sign In</Link>
      </motion.p>
    </motion.div>
  );
};
