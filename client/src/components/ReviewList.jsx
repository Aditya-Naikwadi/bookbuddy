...
const ReviewList = ({ bookId, currentUserId }) => {
  ...
  const {
    ...
    queryFn: ({ pageParam = 1 }) => getBookReviews(bookId, { pageParam, limit: 10 }),
  ...
  useEffect(() => {
    ...
    const ownReview = allReviews.find((r) => {
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <StarRatingInput value={review.rating} readOnly size={16} className="mt-1" />
                    </div>
                    {review.createdAt && (
