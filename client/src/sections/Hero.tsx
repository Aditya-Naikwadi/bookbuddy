...
export const Hero = () => {
  ...
  const cardVariants: Variants = {
    ...
    visible: { opacity: 1, y: 0, transition: { duration: 1, ease: [0.34, 1.56, 0.64, 1] } }
  };
  ...
  return (
    <section ref={containerRef} className="relative w-full min-h-[100dvh] overflow-hidden bg-void flex items-center">
      <div className="relative z-0 max-w-7xl mx-auto w-full px-6 md:px-12 xl:px-24 flex flex-col md:flex-row items-center pt-32 pb-12 pointer-events-none">
        ...
        >
          ...
          <motion.h1 variants={textItemVariants} className="font-serif text-5xl md:text-6xl lg:text-[72px] leading-[1.1] tracking-tight text-gradient-primary mb-4 md:mb-6 mt-4">
            The Library in <br className="hidden md:block"/> Your Pocket.
          </motion.h1>
          <motion.p variants={textItemVariants} className="text-base md:text-lg text-muted mb-8 max-w-md leading-relaxed">
        ...
        <div className="flex w-full md:w-1/2 h-[50dvh] md:h-full relative items-center justify-center pointer-events-none z-10 scale-[0.7] sm:scale-90 md:scale-[0.95] lg:scale-100 mt-12 md:mt-0">
          <div className="relative w-full max-w-lg aspect-square">
            ...
            <motion.div style={{ y: glowY }} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-gradient-to-tr from-indigo-500/20 via-fuchsia-500/10 to-transparent rounded-full blur-[100px]" />
            ...
            >
              <motion.div animate={floatAnimation} className="w-full h-full flex flex-col gap-4">
                ...
                <div className="h-32 bg-gradient-to-br from-white/10 to-transparent rounded-xl w-full border border-white/10 relative overflow-hidden flex items-end p-4">
                  <motion.div style={{ y: bgY }} className="absolute -inset-10 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-30 mix-blend-overlay" />
            ...
            >
              <motion.div animate={floatAnimation} transition={{ delay: 0.5, ...floatAnimation.transition }}>
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-amber-500/10 to-transparent pointer-events-none" />
                <div className="text-5xl mb-3 drop-shadow-[0_0_25px_rgba(245,158,11,0.8)] text-center">🔥</div>
                <div className="text-2xl md:text-3xl font-bold text-white mb-1 drop-shadow-md text-center">14 Days</div>
                <div className="text-[10px] md:text-xs text-amber-200/80 font-medium tracking-wide uppercase text-center">Reading Streak</div>
              </motion.div>
            </motion.div>
            ...
            >
              <motion.div animate={floatAnimation} transition={{ delay: 1, ...floatAnimation.transition }} className="w-full h-full flex flex-col justify-end">
                <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-black/40 via-transparent to-transparent w-4" /> {/* Spine */}
