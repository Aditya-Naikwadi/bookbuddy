          ...
          {[
            {
              ...
              text: "BookBuddy completely changed how I use the library. The availability alerts alone saved my finals week.",
            },
            {
              name: "Jessica Smith",
              inst: "NYU",
              text: "I love the streaks feature! It actually motivates me to read the public domain books during my commute.",
            },
            {
              name: "David Osei",
              inst: "University of Toronto",
              text: "Having my patron card on my phone means I never have to dig through my wallet at the self-checkout kiosk again.",
            },
          ].map((t, i) => (
            <motion.div
              key={i}
