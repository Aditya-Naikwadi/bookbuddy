...
const bentoBlocks = [
  {
    ...
    accent:
      "bg-indigo-500/10 text-indigo-400 border-indigo-500/20 shadow-[inset_0_0_20px_rgba(79,70,229,0.1)]",
  ...
  },
  {
    ...
    accent:
      "bg-success/10 text-success border-success/20 shadow-[inset_0_0_20px_rgba(22,163,74,0.1)]",
  ...
  },
  {
    ...
    accent:
      "bg-ember/10 text-ember border-ember/20 shadow-[inset_0_0_20px_rgba(217,119,6,0.1)]",
  ...
  },
  {
    ...
    accent:
      "bg-danger/10 text-danger border-danger/20 shadow-[inset_0_0_20px_rgba(220,38,38,0.1)]",
  ...
  },
  {
    ...
    accent:
      "bg-cyan-500/10 text-cyan-400 border-cyan-500/20 shadow-[inset_0_0_20px_rgba(6,182,212,0.1)]",
  ...
  },
  {
    ...
    accent:
      "bg-fuchsia-500/10 text-fuchsia-400 border-fuchsia-500/20 shadow-[inset_0_0_20px_rgba(217,70,239,0.1)]",
    centerIcon: true,
  ...
  },
  {
    ...
    accent:
      "bg-teal-500/10 text-teal-400 border-teal-500/20 shadow-[inset_0_0_20px_rgba(20,184,166,0.1)]",
        ...
        <div className="columns-1 md:columns-2 lg:columns-3 xl:columns-4 gap-4 md:gap-6 space-y-4 md:space-y-6">
          {bentoBlocks.map((block, i) => (
            ...
            >
              ...
              <div
                className={`absolute -top-32 -left-32 w-64 h-64 ${block.glowColor} opacity-0 group-hover:opacity-15 transition-opacity duration-700 rounded-full blur-[80px] pointer-events-none`}
              />

              <div className="flex items-center gap-3 mb-6 relative z-10">
                <div
                  className={`flex items-center gap-2 p-3 rounded-2xl border ${block.accent} ${block.centerIcon ? "mx-auto mt-4" : ""}`}
                >
                  {block.icons}
                </div>
              </div>
              ...
              <div
                className={`mt-auto relative z-10 ${block.centerIcon ? "text-center" : ""}`}
              >
                <span className="text-[11px] font-bold tracking-widest text-muted uppercase mb-2 block">
                  {block.group}
                </span>
                <h3 className="text-xl md:text-2xl font-semibold text-ink mb-3 transition-colors">
                  {block.title}
                </h3>
